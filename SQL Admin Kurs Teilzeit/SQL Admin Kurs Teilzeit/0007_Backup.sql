...
Vollständige Sicherung		V alle Dateien und PFade und Inhalt ohne Luft, Checkpoint schreibt Daten weg
differentielle Sicherung	D Differenz  zu letzten V (alle Seiten, die geändert wurden, werden gesichert
Transaktionsprotokoll		T sichert Anweisungen (INS UP DEL)..seit der letzten T Sicherung

--Ansage: wie groß darf der max Datenverlust sein
...
--max Datenverlust oder evtl kürzer
